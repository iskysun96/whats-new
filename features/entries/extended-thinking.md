...
2. **Toggle thinking**: Use `/t` to turn thinking display on or off in your session.
...
4. **Ultrathinking**: For the most complex problems, Claude automatically engages deeper reasoning. No special command needed — it scales thinking to match problem difficulty.
...
- Turn off thinking display with `/t` when you're doing rapid-fire simple tasks and don't need to see the reasoning

## Status history
- **2025-05-01 (v1.0.0)**: Released with extended thinking and `/t` toggle
